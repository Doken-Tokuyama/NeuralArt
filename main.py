...
print("Chargement du modèle VGG-19")
model = load_vgg_model("pretrained_cnn/imagenet-vgg-verydeep-19.mat")
...
J = total_cost(tf.cast(J_content,tf.float32),tf.cast(J_style,tf.float32))
...
def model_nn(sess, input_image, num_iterations=5000):
    ...
    for i in range(num_iterations):
        ...
        if i % 20 == 0:
            ...
            print("Iteration " + str(i)+" à "+str(datetime.datetime.now()) + " :")
